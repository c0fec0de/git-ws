...
ProjectPaths: TypeAlias = tuple[ProjectPath, ...]
...
GroupFilters: TypeAlias = tuple[GroupFilter, ...]
"""
...
GroupSelects: TypeAlias = tuple[GroupSelect, ...]
"""Group Selects."""
...
class Remote(BaseModel):
    ...
    url_base: str | None = Field(default=None, alias="url-base")
...
FileRefs: TypeAlias = tuple[FileRef, ...]
...
MainFileRefs: TypeAlias = tuple[MainFileRef, ...]
...
WorkspaceFileRefs: TypeAlias = list[WorkspaceFileRef]
...
class AppConfigData(BaseSettings):
    ...
    This local filesystem cache directory will be used, to reuse already cloned data.
